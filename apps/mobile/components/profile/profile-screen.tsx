...
const styles = StyleSheet.create({
  ...
  container: { backgroundColor: '#f6f8fc', flex: 1, padding: 24 },
  deleteLink: {
    color: '#b42318',
    fontSize: 15,
    fontWeight: '600',
  ...
  loadingText: { color: '#526074', fontSize: 16, marginTop: 12 },
  subtitle: { color: '#526074', fontSize: 16, lineHeight: 23, marginTop: 8 },
